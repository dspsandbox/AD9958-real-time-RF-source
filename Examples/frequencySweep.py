##############################################################################
# FREQUENCY SWEEP EXAMPLE. Frequency sweep on ch0 and ch1 with different 
...
# 	* TRIGG_OUT is used for monitoring the sweep 
#-----------------------------------------------------------------------------
# MIT License
...
RF.setSweepParameters(0.5e6,10e6,10e-6,30e-6)
RF.setAmplitude(0,1) 
RF.setPhase(0,0)
...
RF.setSweepParameters(0.5e6,10e6,10e-6,10e-6)
RF.setAmplitude(0,1) 
RF.setPhase(0,0)
